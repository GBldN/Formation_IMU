 ...
 * Programme exemple N°5 : AJOUT DES CALCULs DES ANGLES DE ROULIS TANGAGE AVEC LE GYROMETRE
 * 
 ...
 *    - Calculer les angles de ROULIS et TANGAGES avec le gyromètre
...
{ 
  ...
  if ( T_ech >= ( 1000 / f_ech) )
  {
    ...
    lacet_gyr   += Gx * float(T_ech) / 1000;
    roulis_gyr  += Gy * float(T_ech) / 1000;
    tangage_gyr += Gz * float(T_ech) / 1000;
