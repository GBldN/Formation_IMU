 ...
 * Programme exemple N°6 : RECTIFICATION DU CALCUL DES ANGLES A PARTIR DU GYROMETRE EN PRENANT EN COMPTE L'INCLINAISON
 * 
 ...
 * 
 * Remarque par rapport au programme précédent : Prise en compte de l'inclinaison de la centrale dans le calcul des vitesses angulaires autour des axes de ROULIS et TANGAGE
 * 
